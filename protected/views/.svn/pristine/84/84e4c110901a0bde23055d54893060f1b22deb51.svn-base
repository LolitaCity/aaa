                        ...
                        <td>
                            ...
                            <label>
                                <?php  switch ($list['statue']){
                                    ...
                                    case 2:echo '已停用';break;
                                    case 4:echo '未通过    | <a onclick="showNoPassMsg(this)" alt="'.trim($list['msg']).'">查看原因</a>';break;
                                }?></label>
                        </td>
                        <td>
...
<script>
    ...
    function showNoPassMsg($this)
    {
    	layer.open({
			...
			area: ['300px', '100px'],
			title: false,
			content: '<div style="padding: 5%">' + $($this).attr('alt') + '</div>',
		});
    }
</script>
