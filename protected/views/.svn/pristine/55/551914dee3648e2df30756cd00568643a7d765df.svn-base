        ...
        function Msg($page){
        	...
        	$.ajax({
                ...
                var one = "<td>";
                    ...
                    one +="<p class='fpgl-td-rw'>任务说明：<b style='color: red; font-size: 15px; font-weight:bold;'>"+data['list'][i]['remark']+"</b></p>";
                    one +="</td>";
                $trTemp.append(one);  
        ...
        <div class="tab1" id="tab1">
            ...
            <div class="menu">
                <ul>
                    ...
                    <!--<li  onclick="showReservation(this, 'pretask')"  value="2" >预订单/预约单</li>-->
                </ul>
            </div>
            <div class="menudiv">
