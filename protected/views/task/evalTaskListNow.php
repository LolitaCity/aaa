   ...
   <style>
    ...
    <script type="text/javascript">
        ...
        function Msg(){
            ...
            var ur = '<?php echo $this->createUrl('task/evaltasklistNowQuery');?>';
            $.ajax({
                type:"POST",
                url:ur,
                async:true,
                ...
                <div id="con_one_1" class="sj-fpgl">
                    ...
                    <div class="fprw-pg" style="width: 99%;">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <p class="fpgl-td-rw">任务编号：<b style="color: Red">(淘宝)</b>
                                    </p>
                                    <p class="fpgl-td-rw">订单编号：</p>
                                    <p class="fpgl-td-rw"><label></label></p>
                                </td>
                                <td class="fpgl-td-zs">
                                    <p class="fpgl-td-rw">买号：</p>
                                    <p class="fpgl-td-rw">店铺名称：</p>
                                </td>
                                <td class="fpgl-td-zs">
                                    <p class="fpgl-td-rw"><span>文字好评:元</span><br>
                                    </p>
                                </td>
                                ...
                                <td>
                                    ...
                                    <p class="fpgl-td-mtop">
                                        <input class="input-butto100-xhs" type="button" value="立即评价" onclick="evaltask('')"/>
                                    </p>
                                    <p class="fpgl-td-mtop">
                                        <input class="input-butto100-xls"  type="button" value="放弃评价" onclick="setfreetask()"/>
                                    </p>
