...
<div class="container-fluid">
 ...
 <input type="hidden" value="<?php echo $taskinfo['userid'] . '_' . $taskinfo['taskid']; ?>" id="task_tag">
    ...
    <div class="row toa">
        ...
        <div class="col-sm-12 col-xs-12 kun  kunr alert-warning">
            <div class="row redal " style="border-radius: 10px 10px 0px 0;"><h4 style="text-align: center;color: #fff;font-weight:bold;" >注意事项（订金）</h4></div>
            <div class="row  " ><h4 style="text-align: center;color: red;font-weight:bold;" >该任务为预订单任务，需要先完成下订金后，等待尾款可支付时间</h4></div>
        </div>
    ...
    <div class="row toa">
        ...
        <div class="col-sm-12 col-xs-12 kun kuny kunr alert-warning">
            <div class="row redal " style="border-radius: 10px 10px 0px 0;"><h4 style="text-align: center;color: #fff;" >核对商品价格（订金）</h4></div>
            <div class="row">
                    ...
                    if ($xhome && count($xhome) > 0 && $xhome[$max]>30){
                        ...
                        <div class="row tdoa">
                            <div class="col-sm-12 col-xs-12 t_red">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="checkbox5" name="tongjia"  value="货比<?=@$num;?>家" >浏览<?=@$num;?>家同类店铺的一款同类商品
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    if ($deep && $deep[$max]>30){
                        ...
                        <div class="row toa">
                            <div class="col-sm-12 col-xs-12 t_red">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="checkbox4" name="liulanqita"  value="浏览店内<?=@$numdeep;?>款其他商品" > 浏览店内<?=@$numdeep;?>款其他商品
                                    </label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-sm-12 col-xs-12" style="font-size: 12px;">
                ...
                <div class="row ">
                    ...
                    <div class="col-sm-6 col-xs-6 t_left ">
                        <div class="checkbox" ?> 
                 			<label>
                 				<input class="step_four" type="checkbox" type="checkbox" id="pay_money" name="checkbox"  value="买前咨询聊天" >付款金额(订金):<span class="shopanmeg" style="color:#000"><?=$taskinfo['handsel'];?></span>
                 			</label> 
                 		</div>
                    </div>
                </div>                
			...
			<?php if($is_use_helper):?>
        	 ...
        	 <?php else:?>
                ...
                <div class="row toa" >
                    ...
                    <div class="col-sm-8 col-xs-8 t_left tdoa">
                          <input type="text"  class="form-control"  disabled = "disabled" value="<?=$taskinfo['handsel'];?>">                         	
               		</div>
                </div>
                <!--文本列表-->
            	<div class="row toa">
                	...
                	<div class="col-sm-8 col-xs-8 t_left ">
                          <input type="text" class="form-control step_four" id="txtPayPrice" name="PayPrice" placeholder="请输入付款金额" onkeyup=" clearNoNum(event, this,'<?=$taskinfo['handsel'];?>') " onblur="checkNum(this)" >
               		 </div>
            	</div>
            	<!--文本列表：end-->
                <div class="row tdoa">
            ...
            <div class="row toa">
                <div class="col-sm-4 col-xs-4">
                    <div style="width: 80px;height: 80px;border: 1px dashed goldenrod;">
                        ...
                        <img  class="img-responsive " id="lang2" style="height: 80px;width: 80px;object-fit: cover;"/>
                    </div>
