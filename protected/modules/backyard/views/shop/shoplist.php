...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main">
            <div class="row">
            	<div class="col-lg-12">
            		<h3 class="page-header"><i class="fa fa-laptop"></i> 用户商品中心</h3>
            		<ol class="breadcrumb">
            			<li><i class="fa fa-home"></i><a href="<?php  echo $this->createUrl('default/index');?>">首页</a></li>
            			<li><i class="fa fa-laptop"></i>用户商品列表</li>						  	
            		</ol>
            	</div>
            </div>
                ...
                <div class="panel-body">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th><div>ID号</div></th>
                                <th><div><div align="center">会员ID</div></th>
                                <th><div><div align="center">店铺类型</div></th>
                                <th><div align="center">掌柜号</div></th>
                                <th><div align="center">店铺名称</div></th>
                                <th><div align="center">店铺性质</div></th>
                                <th><div align="center">发货人</div></th> 
                                <th><div align="center">发货地址</div></th>
                                <th><div align="center">提交时间</div></th>
                                <th><div align="center">店铺状态</div></th>
                                <th><div align="center">审核状态</div></th>
                                <th><div align="center">审核时间</div></th>
                                <th><div align="center">添加IP</div></th>
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr style="color:#666;height:75px;">
                                <td style="vertical-align: middle;"><?php echo $item->sid?></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->userid?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->type=='0'?'淘宝':'京东'?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->manager_num;?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->shopname;?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->nature=='0'?'个人':'公司'?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->sendname?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->sendarea;?><br/><?php echo $item->sendaddress;?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo date('Y年m月d日 H:i:s',$item->addtime);?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->status=='0'?'不可使用':'可使用';?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php if($item->auditing=='0'):?><span style="color: red;">未审核<?php elseif($item->auditing=='1'):?><span style="color: green;">已通过<?php else:?><span style="color: red;">已驳回<?php endif;?></span></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->auditingtime==""?'<span style="color: red;">未审核</span>':date('Y年m月d日 H:i:s',$item->auditingtime);?></div></td>
                                <td style="vertical-align: middle;"><div align="center"><?php echo $item->addIP!=""?$item->addIP:"获取失败";?></div></td> 
                                <td style="vertical-align: middle;"><div align="center"><a href="<?php echo $this->createUrl('shop/shopEdit',array('sid'=>$item['sid']));?>">查看详情</a></div></td> 
                            </tr>
                            <?php
                                }
                            ?>
