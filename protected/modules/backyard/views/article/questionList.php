...
<html lang="en">
	<head>
	    ...
	    <title>数据分析中心</title>				<!-- Fav and touch icons -->
	...
	<div class="container-fluid content">
        ...
        <div class="panel panel-default"><!--theBody start-->
            <div class="panel-heading">
                【<a href="<?php  echo $this->createUrl('article/questionadd');
                ?>
                ">添加</a>】
...
<?php if (@$list){
    ...
    ?>
                        <tr>
                            <td><a style="font-weight: normal;" ><?php echo $v['question_type'];?></a></td>
                            <td><a style="font-weight: normal;" ><?php echo $v['order'];?></a></td>
                        <td><?php echo $v['statue']==1?'是':'否';?></td>
                            <td>
                                <a href="<?php echo $this->createUrl('article/questionadd',array('qid'=>$v['id']));?>" title="修改文档" style="color:green; font-weight: normal;">
                                    <i class="fa fa-edit"></i>
                                </a>　
                                <!--<a onclick='if(confirm("您确定删除吗？删除后将放入回收站")) return ture; else return false;' title="删除文档到回收站" href="">
