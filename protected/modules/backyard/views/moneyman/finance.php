	...
	<div class="container-fluid content">
		...
		<div class="main">
            ...
            <div class="panel panel-default"><!--theBody start-->
               <br>
                    <form onsubmit="<?=$this->createUrl('moneyman/finance')?>" method="get" style="margin-left: 10px" action="<?=$this->createUrl('moneyman/finance')?>">
                        <input class="text-box" name="Username" value="<?=@$_GET['Username']?>" id="Username" placeholder="用户名" style="height: 32px; line-height:30px; ">
                        <button type="submit" class="btn btn-sm btn-success" border="0" id="reg_submit" style="position:relative; top:-1px;">
                            <i class="fa fa-dot-circle-o"></i>&nbsp;确认搜索</button>
                    </form>
<br>
                <div class="panel-heading">
                    <i class="fa fa-indent red"></i>
					<?php if($_GET['type']==1){ ?>
                    <span>财务报表—现金|<a href="<?php  echo $this->createUrl('moneyman/finance',array('type'=>2));?>"></a></span>
					<?php }else{ ?>
					<span>财务报表—<a href="<?php  echo $this->createUrl('moneyman/finance',array('type'=>1));?>">现金</a></span>
					<?php } ?>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><div align="center">金额增减情况</div></th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><div align="center"><?=$item->increase?></div></td>
                                <td><div align="center"><?=$item->type?></div></td>
                                <td><div align="center"><?php echo date("Y-m-d H:i:s",$item->addtime);?></div></td>
								<td><div align="center"><?php echo $item->remoney;?></div></td>
                            </tr>
                        <?php
                            }
                        ?>
