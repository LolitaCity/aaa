                ...
                <div class="panel-body">
                    <div class="form-group">
                        <form method="post" action="<?php echo $this->createUrl('system/exam');?>" class="form-horizontal">
                            ...
                            <div class="examItem">
                                <label class="col-sm-3 control-label" for="input-small" style="width: auto;">题目级别</label>
                                <div class="col-sm-3">
                                    <input type="radio" checked="checked" value="1" name="type" class="answer" /> 　初级
                                    <input type="radio" value="2" name="type" class="answer" /> 　高级
                                    <input type="radio" value="3" name="type" class="answer" /> 　终极
                                </div>
                            </div><br /><br />
                            <div class="examItem">
                                <div class="col-sm-10">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td colspan="6">
                                <br>
                                <a <?php if (@$_GET['type']==1 || empty($_GET['type'])){?>style="text-decoration: underline;color: blue;"<?php }?> href="<?php echo $this->createUrl('system/exam',array('type'=>1));?>">初级题目</a>
                                <a <?php if (@$_GET['type']==2){?>style="text-decoration: underline;color: blue;"<?php }?>  href="<?php echo $this->createUrl('system/exam',array('type'=>2));?>">     高级题目</a>
                                <a <?php if (@$_GET['type']==3){?>style="text-decoration: underline;color: blue;"<?php }?> href="<?php echo $this->createUrl('system/exam',array('type'=>3));?>">     终极题目</a>
                            </td>
                        </tr>
                            <tr>
                                <th>题目</td>
