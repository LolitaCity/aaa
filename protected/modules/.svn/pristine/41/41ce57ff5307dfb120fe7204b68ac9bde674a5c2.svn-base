                    ...
                    <div class="form-group">
                        <form method="post" action="<?php echo $this->createUrl('system/baseset');?>" class="form-horizontal">
							...
							<div class="examItem">
                                ...
                                <div class="col-sm-3" style="width: auto;">
    		                        <input type="text" name="monthAccount" id="input-small" name="input-small" class="form-control input-sm" style="width: 100px; display: inline;" value="<?php echo $monthAccount->value;?>"/><span style="padding-left: 10px; color:red;">日</span>
    		                    </div>
                            </div><br /><br />
